---
title: "The anthropocentrism trap, Part 2"
author: "RSM"
categories: ["other stories"]
showSidebarSummary: true
summary: "What the bias conceals. "
weight: 2
---
...
[^1]: Harry J. Jerison, *Evolution of the Brain and Intelligence* (Academic Press, 1973).

[^2]: On neural demands of terrestrial somatic coordination, see Herculano-Houzel, "The Human Advantage: How Our Brains Became Remarkable" (MIT Press, 2016), especially the discussion of how body plan constrains brain allocation across species.

[^3]: On the argument that blubber inflates body mass without adding proportional neural load (skewing EQ systematically against aquatic mammals), see Lori Marino, "Brain-behavior relationships in cetaceans and primates: Implications for the evolution of complex intelligence," *Proceedings of the Joint International Conference on Cognitive Science* (1996).

[^4]: The within-species body mass variation argument is discussed in Cairo et al., "Encephalization in cetaceans: an evolutionary perspective," *Brain, Behavior and Evolution* (2006).