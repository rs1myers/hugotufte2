...
This idea isn't controversial in physics. As philosopher Eliot Sober notes in his review of Thomas Nagel's work, "Scientists already leave room for brute facts... When they say that a law is 'fundamental,' they mean that it can't be explained by anything deeper." {{< sidenote >}} Elliot Sober, ["Remarkable Facts,"](https://www.bostonreview.net/articles/remarkable-facts/Boston) 50 Review, November 7, 2012 {{< /sidenote >}} Physicist Sean Carroll puts it even more directly: “At the deepest level, the laws of physics might just be brute facts. Asking for something deeper could simply be a confusion.” {{< sidenote >}}Sean Carroll, *The Big Picture*, p. 355){{< /sidenote >}}

Curiously, this straightforward acknowledgment in physics rarely extends to considerations of consciousness. When it comes to the mind, we're told that it must reduce to something more basic, that subjective experience must be explainable in terms of purely physical processes. Irreducibility is acceptable for charge and mass and quantum fields, but not for consciousness.
...
But the moment we accept that physical properties themselves are irreducible---that charge, mass, fields, and fundamental laws simply exist without deeper explanation---this supposed advantage dissolves. Consider what philosopher Galen Strawson calls "physically-inflationary metaphysics":{{< sidenote >}}Strawson, G. (2008). "Real naturalism," in *Real materialism and other essays* (pp. 53–74). Oxford University Press.{{< /sidenote >}} the assumption that we know what "the physical" is, and that we know it can't include anything experiential. But physics actually tells us nothing about the intrinsic nature of matter. As Bertrand Russell argued nearly a century ago 

> Physics is purely structural; it tells us nothing of the intrinsic character of physical events. If anything is known about intrinsic character, it is known through experience. Thus, the mental is the only example we have of intrinsic character; mind and matter cannot be categorically opposed.{{< sidenote >}}Bertrand Russell, *The Analysis of Matter*, 1927{{< /sidenote >}}
...
> It’s ironic that the people who are most likely to doubt or deny the existence of consciousness (on the ground that everything is physical, and that consciousness can’t possibly be physical) are also those who are most insistent on the primacy of science, because it is precisely science that makes the key point shine most brightly: the point that there is a fundamental respect in which ultimate intrinsic nature of the stuff of the universe is unknown to us — except insofar as it is consciousness.{{< sidenote >}}Galen Strawson, "Consciousness Isn't a Mystery, It's matter," New York Times opinion, May 16, 2016{{< /sidenote >}}

If one accepts this perspective, the landscape transforms. Both worldviews—reductive materialism and fundamental mind—rest on the same foundation: unexplained primitives. Neither explains "all the way down." Both make a choice about what to place at the bottom of their explanatory hierarchy.
Physicalism says: Matter is fundamental and unexplained. Mind somehow emerges from it (also unexplained at the deepest level).

A consciousness-inclusive view says: Mind (or proto-experiential properties) is fundamental and unexplained. Physical structure and behavior somehow relate to it (also unexplained at the deepest level).

The structures are identical. They differ only in what they choose as primitive.
...
Second, it reveals the mind-body problem as potentially misconceived. If consciousness is a fundamental, irreducible property of reality---as basic as charge or mass---then asking "how does matter produce consciousness?" is like asking "how does the universe produce charge?" The question assumes something needs explaining that might simply be. As Strawson argues more forcefully, once you accept irreducible properties, "the mind-body problem is a non-problem"---a false puzzle created by mistaken assumptions about what requires explanation.

Third, it transforms the question from "which view is true?" to "which primitives make more sense given everything we know?" And here the balance shifts. Physical properties like charge and mass don't predict or necessitate consciousness---there's nothing about the mathematics of quantum field theory that suggests "and this will produce subjective experience." But if consciousness (or proto-experiential properties) is fundamental, then the rich inner life of complex organisms becomes expected rather than miraculous, natural rather than inexplicable.
...
So where does this leave us? Not with proof that consciousness is fundamental---such proof may be impossible in principle. Not with certainty that reductive materialism is false---it remains a coherent metaphysical position. But with something equally important: recognition that both frameworks are metaphysically legitimate choices resting on comparable foundations.

Neither worldview can claim epistemic superiority based on "explaining more" or "assuming less" or being "more scientific." Both bottom out in primitives. Both require metaphysical commitments beyond what science alone can establish. Both are metaphysical commitments, different in type but not in kind, and both are informed by evidence, coherence, and consequences.

As equally legitimate metaphysical frameworks, a question arises: What follows from living as if each were true? What does each worldview generate in terms of meaning, ethics, value, and action? What kind of world does each create when taken seriously? When metaphysical proof is impossible but practical consequences are undeniable, the question transforms. We can't settle the metaphysics conclusively, but we can evaluate the sorts of things that each framework leads to when actually lived.
