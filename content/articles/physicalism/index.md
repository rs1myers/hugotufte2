...
summary: "The idea that it's physical stuff all the way down."
weight: 3
...
deterministically{{< sidenote >}}Roughly speaking, determinism is the idea that objects will maintain{{< /sidenote >}} through space and time. Nothing exists that cannot
...
This view of the universe, typically known as “physicalism,”{{< sidenote >}}The term “physicalism” is used here in a generally used in reference{{< /sidenote >}} has been
...
colleagues.{{< sidenote >}}The story behind what is referred to as “quantum foundations” and{{< /sidenote >}}
...
implications of their findings{{< sidenote >}}Heisenberg’s “The Philosophical Implications of Quantum Mechanics”{{< /sidenote >}} (Einstein was a notable exception).{{< sidenote >}}Einstein did not accept the core aspect of QM: that at bottom matter{{< /sidenote >}}
Pauli was far less subjected to such attacks, perhaps because he
understood QM better than just about anyone.{{< sidenote >}}In the early days of QM only a few people knew enough about it to{{< /sidenote >}}
...
independently with other particles according to the laws of physics.{{< sidenote >}}This is admittedly something of a gross over-simplification, but it{{< /sidenote >}}
An electron (or any other particle) is instead a “cloud of
potentialities”{{< sidenote >}}A term used by Henry Stapp in “A Mindful Universe”{{< /sidenote >}} that extends to infinity. A particle only appears
...
point in space time.{{< sidenote >}}Another finding of modern physics is that space and time are{{< /sidenote >}} At this point, and only at this point, can a
...
perspectives of scientism, that does not appear to be the case.{{< sidenote >}}That the modern scientific program misses a very large part of{{< /sidenote >}} And
...
> principle sufficient to understand the universe as a whole.”{{< sidenote >}}Thomas Nagel, *Mind & Cosmos,* p. 31{{< /sidenote >}}
...
other.{{< sidenote >}}Mass and energy are equivalent but different ways of expressing the{{< /sidenote >}}

Nuclear power comes from converting matter into energy.{{< sidenote >}}It is theoretically possible but highly impractical to convert{{< /sidenote >}} But The
...
rest is known as “dark matter.”{{< sidenote >}}There is some controversy over this: see Modified Newtonian{{< /sidenote >}} Most contemporary scientists and
...
descriptions of results.{{< sidenote >}}*Conscious Universe*, p. 76 (Kafatos & Nadeau){{< /sidenote >}}
...
> necessarily partial.{{< sidenote >}}Marcus Appleby, “Mind and Matter: A Critique of Cartesian{{< /sidenote >}}
...
> tiny interacting parts of a kind known not to exist.”{{< sidenote >}}Henry Stapp: “Attention, Intention, and Will in Quantum Physics”,{{< /sidenote >}}
...
> reality?“{{< sidenote >}}Isaac Asimov, “Limitations”, Introduction to *Flatland*, Barnes &{{< /sidenote >}}
